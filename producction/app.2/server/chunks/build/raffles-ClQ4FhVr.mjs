...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-ae91a691><div data-v-ae91a691>`);
      _push(ssrRenderComponent(_component_TicketCard, {
        nombre: "Deibys Paredes",
        cedula: "18221836",
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/raffles.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const raffles = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-ae91a691"]]);

export { raffles as default };
//# sourceMappingURL=raffles-ClQ4FhVr.mjs.map
